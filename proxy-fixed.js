    ...
    if (url.startsWith('/api/')) {
        ...
        <body>
            <div class="container">
                ...
                <a href="/proxy-index.html" class="btn">📂 Открыть Graph Editor</a>
                <a href="/test-page.html" class="btn">🔍 Проверить систему</a>
            </div>
        </body>
        </html>`;
...
server.listen(PORT, () => {
    ...
    console.log(`📡 Проксирует к API на порту из api_port.txt`);
});