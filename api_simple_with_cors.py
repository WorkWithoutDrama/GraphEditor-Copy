#!/usr/bin/env python3
"""
Упрощенный API с CORS поддержкой и выводом JSON в логи
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("🚀 ЗАПУСК API С CORS ПОДДЕРЖКОЙ И ВЫВОДОМ JSON")
    print("=" * 60)
    print("✅ CORS заголовки добавлены (OPTIONS, preflight)")
