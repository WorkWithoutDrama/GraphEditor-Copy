...
```json
{
  "connection_out": "o00001s00001",  // состояние "незарегистрирован"
  "connection_in": "a00001"          // действие "Регистрация"
}
```
...
```json
{
  "connection_out": "a00001",        // действие "Регистрация"
  "connection_in": "o00001s00002"    // состояние "зарегистрирован"
}
```
