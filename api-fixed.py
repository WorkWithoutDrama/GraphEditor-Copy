...
4. action_links и object_links должны содержать manual, API, UI
...
- Добавляй action_links и object_links
            ...
            "model_actions": [
                {
                    ...
                    "action_links": {
                        "manual": "https://example.com/docs/demo-action",
                        "API": "/api/demo-action",
                        "UI": "/demo-action"
                    }
                }
            ...
            "model_objects": [
                {
                    ...
                    "object_links": {
                        "manual": "https://example.com/docs/demo-object",
                        "API": "/api/demo-object",
                        "UI": "/demo-object"
                    }
                }
