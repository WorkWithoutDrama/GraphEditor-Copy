...
# Запускаем тестовый API в фоне и показываем логи в реальном времени
python3 api_main.py 2>&1 | tee api_startup.log &
API_PID=$!
echo "   📝 Логи API пишутся в: api_startup.log и отображаются ниже"
